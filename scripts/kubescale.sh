...
# docker build -t local.docker.cn:5000/kubescale:$TAG -f 

# # echo "building set image"

# cd set; docker build -t local.docker.cn:5000/set:$TAG -f set/Dockerfile .
...
# docker push local.docker.cn:5000/kubescale:latest
# docker push local.docker.cn:5000/set:latest
