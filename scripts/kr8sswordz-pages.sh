...
docker build -t local.docker.cn:5000/kr8sswordz:$TAG -f applications/kr8sswordz-pages/Dockerfile applications/kr8sswordz-pages
...
#Push the images
docker push local.docker.cn:5000/kr8sswordz:$TAG

#Stop the registry proxy
docker stop socat-registry

# Create the deployment and service for the front end aka kr8sswordz
sed 's#local.docker.cn:5000/kr8sswordz:latest#local.docker.cn:5000/kr8sswordz:'$TAG'#' applications/kr8sswordz-pages/k8s/deployment.yaml | kubectl apply -f -
